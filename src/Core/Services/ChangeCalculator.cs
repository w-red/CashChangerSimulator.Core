...
public class ChangeCalculator
{
    ...
    public IReadOnlyDictionary<DenominationKey, int> Calculate(IReadOnlyInventory inventory, decimal targetAmount, string? currencyCode = null, Func<DenominationKey, bool>? filter = null)
    {
