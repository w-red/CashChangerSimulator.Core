...
public interface IUposMediator
{
    ...
    void VerifyState(bool skip, bool mustBeClaimed = true, bool mustBeEnabled = false, bool mustNotBeBusy = false);
    ...
    void Execute(IUposCommand command, bool skipStateVerification);
}
